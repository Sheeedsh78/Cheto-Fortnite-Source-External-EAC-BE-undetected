...
namespace Settings {
	...
	float Skeletonchik[3] = { color.RGBRed[0], color.RGBRed[1], color.RGBRed[2] };
	...
	float LineESP[3] = { color.Sexycyan[0], color.Sexycyan[1], color.Sexycyan[2] };
